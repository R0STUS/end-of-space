function drawCHub()
    ...
    love.graphics.setColor(btnColR, btnColG, btnColB, 1.0)
    love.graphics.rectangle("fill", xCenter - (width * 0.215), height * 0.75, width * 0.075, height * 0.045)
    love.graphics.rectangle("fill", xCenter, height * 0.75, width * 0.075, height * 0.045)
    love.graphics.rectangle("fill", xCenter - (width * 0.11), height * 0.75, width * 0.075, height * 0.045)
    love.graphics.setColor(1, 1, 1)
    love.graphics.print("Cancel", xCenter - (width * 0.215) + (height * 0.005), height * 0.75 + (height * 0.015))
    love.graphics.print("Add", xCenter + (height * 0.005), height * 0.75 + (height * 0.015))
    love.graphics.print("Remove", xCenter - (width * 0.11) + (height * 0.005), height * 0.75 + (height * 0.015))
    love.graphics.setColor(btnColR, btnColG, btnColB, 1.0)
